<form action="<?php echo base_url('mzsj/adminedit/editadmin/'.$info['adminid']);?>" class="form-box" method="post">
        <input type="hidden" name="adminid" value="<?php echo $info['adminid']?>" />
        <input type="hidden" name="info[roleid]" value="<?php echo $info['roleid']?>" />
